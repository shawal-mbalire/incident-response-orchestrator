...
from incident_response.toolsets.notifications_toolset import NotificationsToolset
...
def create_app(settings: Settings | None = None):
    ...
    if settings.environment == "production":
        ...
        notifications_port = PubSubNotificationsAdapter(project_id="dev-project")
    ...
    notifications_toolset = NotificationsToolset(notifications_port)
